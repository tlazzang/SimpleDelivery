...
public interface ErrandService {
    ...
    //반경 몇km 까지 심부름의 푸시알람을 받을건지 업데이트함.
    @PATCH("/me/setting-distance")
    Call<ResponseBody> updateSettingDistance(@Header("x-access-token") String token, @Query("setting_distance") int setting_distance);
